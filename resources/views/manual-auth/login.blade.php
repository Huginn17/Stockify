            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('loginproses') }}" method="POST">
                        ...
                        <button type="submit" class="w-full btn-stockify">Login</button>
                        

      <p class="text-sm font-light text-gray-500 dark:text-gray-400" style="margin-top: 1.5%;">Belum Memiliki Akun?
      <a href="#"class="font-medium text-primary-600 hover:underline dark:text-primary-500">Daftar</a>
                        </p>
