...
<section class="bg-orange-400 dark:bg-gray-900 py-8 px-4">
        ...
        <div class="overflow-x-auto sm:rounded-lg shadow">
            <table class="w-full text-sm text-left text-gray-700 dark:text-gray-200 dark:border-gray-700 shadow-md">
                <tbody>
                    ...
                    <tr class="odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
                        <th class="px-6 py-3 font-medium">Gambar</th>
                        <td class="px-6 py-3">
                            @if ($produk->image)
                                <img src="{{ asset('storage/' . $produk->image) }}" alt="Gambar Produk" class="w-28 h-28 object-cover rounded shadow">
                            @else
                                <span class="italic text-gray-400">Tidak ada gambar</span>
                            @endif
                        </td>
                    </tr>
                    <tr class="bg-gray-100 dark:bg-gray-800 odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 border-gray-200">
    ...
    @csrf
    <button type="submit" style="font-size: medium; text-decoration: none; border-radius: 20vh" class="bg-orange-500 hover:bg-orange-400 text-white hover:text-blue-800 font-bold text-sm inline-flex items-center px-4 py-2">
        Kembali
    </button>
</form>
