...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
      <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Update Data Kategori</h2>
          ...
          <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
              <div class="sm:col-span-2">
               ...
               <div class="sm:col-span-2">
                 ...
                 <textarea name="description" id="description" value="{{ $kategori->description }}" cols="30" rows="10"></textarea>
              </div>
          </div>
