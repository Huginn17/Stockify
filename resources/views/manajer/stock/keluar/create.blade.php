...
@section('contentmanajer')
    <div class="p-4 sm:ml-64">
        ...
        <div class="max-w-2xl mx-auto bg-gray-800 dark:bg-gray-800 rounded-xl shadow-lg  p-6">
            <h2 class="mb-4 text-2xl font-bold text-white dark:text-white text-center">Barang Keluar </h2>
            <div class=" p-10 bg-gray-50 sm:rounded-lg">
                <form action="{{ route('manajer.stock.keluar.store') }}" method="POST">
                    @csrf
                    <div>
                        <label for="product_id" class="block mb-2 text-sm font-medium text-black     dark:text-black">Produk
                            :</label>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            <label for="quantity" class="block mb-2 text-sm font-medium text-black dark:text-black">Jumlah
                                Keluar :</label>
                        ...
                        <div>
                            <label for="date" class="block mb-2 text-sm font-medium text-black dark:text-black">Tanggal
                                Keluar :</label>
                        ...
                        <div class="sm:col-span-2">
                            <label for="notes" class="block mb-2 text-sm font-medium text-black dark:text-black">Catatan
                                :</label>
                            <textarea name="notes" id="notes" rows="8"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-whit rounded-lg  border-gray-800 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    ...
                    <div class="mt-6 flex justify-between items-center">
                        ...
                        <a href="{{ route('manajer.stock') }}" style="font-size: medium; text-decoration: none;"
                            class="bg-orange-500 hover:bg-orange-800 btn  rounded-full font-bold text-white">
                            Kembali
                        </a>
                    </div>
                </form>
