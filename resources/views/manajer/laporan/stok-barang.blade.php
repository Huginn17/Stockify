...
@section('contentmanajer')
    <div class="p-4 sm:ml-64">
        <div class="bg-gray-800 p-6 sm:rounded-lg shadow-lg mb-4  flex justify-between items-center">
            <h2 class="text-2xl font-bold text-white">Laporan Stok Barang Per Bulan & Kategori 📂</h2>
            <a href="{{ route('manajer.laporan.masuk') }}" style="text-decoration: none;"
                class="inline-flex items-center px-4 py-2 bg-orange-500 hover:bg-orange-300 text-white font-bold rounded-full shadow transition duration-300">
                Kembali
            </a>
        </div>
